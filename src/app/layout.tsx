...
export const metadata: Metadata = {
  ...
  description:
    'Fovilight: universal LED strip controller for WS2812, WS2815, SK6812, APA102 & 20+ types. LedID™ auto-detection, AI effects, local-first, Home Assistant compatible. No soldering. EU shipping. Govee & Philips Hue Lightstrip alternative.',
  keywords: [
    ...
    'local control LED strip',
    'no cloud LED strip',
    'LED strip Home Assistant',
    ...
    'Govee alternative',
    'Philips Hue Lightstrip alternative',
    'WLED alternative',
    'LED strip no soldering',
    'gaming LED strip controller',
    'smart LED strip EU',
  ],
